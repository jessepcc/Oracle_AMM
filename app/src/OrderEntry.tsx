...
export function OrderEntry(props: {
    ...
    useEffect(() => {
        if (qtyBn !== undefined && props.approxPrice !== undefined) {
            setApproxQuoteSize(
                tokenQtyToNumber(qtyBn, props.baseToken.decimals) *
                    props.approxPrice
            );
        } else {
        ...
        <div>
            <div>
                ...
                {qtyBn !== undefined && approxQuoteSize !== undefined ? (
                    props.isBuy ? (
                        <p>
                            Pay {approxQuoteSize.toFixed(3)}{" "}
                            {props.quoteToken.name} to receive{" "}
                            {tokenQtyToNumber(
                                qtyBn,
                        ...
                        <p>
                            ...
                            {props.baseToken.name} to receive{" "}
                            {approxQuoteSize.toFixed(3)} {props.quoteToken.name}
                        </p>
                    )
                ) : (
